...
#parâmetros do raxml
    def Commands(self):
        ...
        lines.append('PREFIX=`basename -s .phylip ${INPUT}`')
        lines.append('PARAM="-T $SLURM_CPUS_PER_TASK -m PROTGAMMAWAG -p 112233 -s ${INPUT} -b 223344 -N $BOOTSTRAP -n ${PREFIX}-hybrid-${SLURM_CPUS_PER_TASK}th-${SLURM_NTASKS}n-${BOOTSTRAP}bs-rep${1}.phylip_tree2.raxml -c 4 -f d"')
